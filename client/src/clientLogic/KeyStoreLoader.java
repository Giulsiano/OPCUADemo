...
class KeyStoreLoader {
    ...
    KeyStoreLoader load(Path baseDir) throws Exception{
        ...
        Path clientKeyStore = baseDir.resolve("client-demo.pfx");
        ...
        if (!Files.exists(clientKeyStore)) {
            ...
            SelfSignedCertificateBuilder builder = new SelfSignedCertificateBuilder(keyPair)
                    .setCommonName("OPCUADemo")
                    .setOrganization("giuls INC")
                    .setOrganizationalUnit("dev")
                    .setLocalityName("Pisa")
                    .setStateName("Tuscany")
                    .setCountryCode("IT")
                    .setApplicationUri("urn:OPCUADemo:client")
